package com.example.springstarbucks.springcybersource;
...
public class CyberSourceAPI {
    ...
    /* CyberSource Card Types:
        ...
        American express 3 visa  4 mastercard 5 discover 6
    ...
    */
    ...
    public static String getCardType(String cardNum) {
        ...
        String type = "ERROR";
        switch(firstNumber) {
            case "3": type = "003"; break;//american express
            case "4": type = "001"; break;//visa
            case "5": type = "002"; break;//mastercard
            case "6": type = "004"; break;//discover
        }
        return type;
    }
